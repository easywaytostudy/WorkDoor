...
urlpatterns = [
    ...
    path('jobnoti', views.jobnoti, name='jobnoti'),
    path('appliedjobs', views.appliedjobs, name='appliedjobs'),
    path('jobsearch', views.jobsearch, name='jobsearch'),
    path('resume', views.resume1, name='resume'),
    path('editprofile', views.editprofile, name='editprofile'),
    path('cdashboard', views.cdashboard, name='cdashboard'),
    path('candisearch', views.candisearch, name='candisearch'),
    path('selectcandi', views.selectcandi, name='selectcandi'),
    path('candinoti', views.candinoti, name='candinoti'),
